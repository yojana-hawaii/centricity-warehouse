...
drop proc if exists cps_hchp.rpt_CaseLoad_HFCM;

go


create proc cps_hchp.rpt_CaseLoad_HFCM
as
begin
	select 
		c.HF_Case_Manager,c.Last, c.First, c.Name, c.PatientID, c.DoB, c.Last_HF_Enroll_date, c.Valid_HF_Discharge_Date,
